...
const StoriesScreen = () => {
  ...
  }, [loadStories]); // Adding loadStories as a dependency
  ...
  }, [currentIndex, stories, loading, markStoryAsViewed, startProgress]); // Added missing dependencies
  ...
  const handlePress = useCallback((event) => {
    ...
    if (locationX < width / 3) {
      ...
      // No need for explicit play/pause calls; shouldPlay prop handles it
    }
  }, [goToPreviousStory, goToNextStory, paused]);
  ...
  }, [stories, currentIndex, navigation, setMenuVisible, setPaused, setStories, setCurrentIndex]);
        ...
        >
          ...
          <View style={[styles.menuContainer, { paddingBottom: insets.bottom > 0 ? insets.bottom : 20 }]}>
            <TouchableOpacity style={styles.menuItem} onPress={handleDeleteStory}>
              ...
              <Text style={[styles.menuItemText, styles.deleteText]}>Delete Story</Text>
            </TouchableOpacity>
          </View>
        </TouchableOpacity>
      </Modal>
