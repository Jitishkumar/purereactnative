...
const CommentScreen = ({ visible, onClose, postId }) => {
  ...
  // Create memoized styles that depend on insets
  ...
  // loadComments function moved inside useEffect to fix dependency issue
      ...
      >
        <View style={styles.modalContent}>
          ...
          <LinearGradient
            ...
            style={[styles.inputContainer, dynamicStyles.inputContainerPadding]}
          >
